...
<script>
	...
	$(document).ready(function() {
		...
		$("#id").attr("readonly",true).attr("disabled",false); //입력불가
		...
		<div class="container">
			...
			<div class="flex-w flex-tr">
				<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
					...
					<form action="customerupdateimpl.mc" method="GET" onsubmit="return joinCheck(this)">
						...
						<div class="col-sm-6 p-b-5 m-lr-auto ">
							<label class="stext-102 cl3" for="id">ID</label> <input
								...
								name="CUSTOMER_ID" value="${customerupdate.CUSTOMER_ID }"
								style="background-color: #A4A4A4">
						</div>

						<div class="col-sm-6 p-b-5 m-lr-auto ">
							<label class="stext-102 cl3" for="pwd">PASSWORD</label> <input
								class="size-111 bor8 stext-102 cl2 p-lr-20" id="pwd" type="text"
								name="CUSTOMER_PWD" value="${customerupdate.CUSTOMER_PWD }">
						</div>
						...
						<div class="col-sm-6 p-b-5 m-lr-auto ">
							<label class="stext-102 cl3" for="pwd">PASSWORD CHECK</label> <input
								...
								onchange="isSame()" type="password" name="CUSTOMER_PWD2">&nbsp;&nbsp;
						...
						<div class="col-sm-6 p-b-5 m-lr-auto ">
							<label class="stext-102 cl3" for="name">NAME</label> <input
								...
								value="${customerupdate.CUSTOMER_NM }">
						</div>
						...
						<div class="col-sm-6 p-b-5 m-lr-auto ">
							<label class="stext-102 cl3" for="name">PHONE</label> <input
								...
								value="${customerupdate.CUSTOMER_PHONE }">
						</div>
						...
						<div class="col-sm-6 p-b-5 m-lr-auto ">
							<label class="stext-102 cl3" for="name">ADDRESS</label> <input
								...
								value="${customerupdate.CUSTOMER_ADDR }">
						</div>
						...
						<div class="col-sm-6 p-b-5 m-lr-auto ">
							<label class="stext-102 cl3" for="email">EMAIL</label> <input
								...
								value="${loginuser.CUSTOMER_EMAIL }">
						</div>
						...
						<label class="stext-102 cl3"></label> <input type="submit"
							...
							style="width: 300px; height: 50px" value="UPDATE" name="registerok">
